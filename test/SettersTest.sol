...
contract SettersTest is BaseTest {
    ...
    function testInitialRoleSetter() public view {
        assertEq(covenant.roleSetter(), address(this), "deployer should be initial role setter");
    }

    function testSetRoleSetterSuccess(address rdm) public {
        covenant.setRoleSetter(rdm);
        assertEq(covenant.roleSetter(), rdm, "role setter should be transferred");
    }
    ...
    function testSetRoleSetterOnlyRoleSetter(address rdm) public {
        ...
        covenant.setRoleSetter(makeAddr("newRoleSetter"));
    }

    function testSetFeeSetterSuccess(address feeSetter) public {
        covenant.setFeeSetter(feeSetter);
        assertEq(covenant.feeSetter(), feeSetter);
    }
    ...
    function testSetFeeSetterOnlyRoleSetter(address rdm) public {
        ...
        vm.prank(rdm);
        vm.expectRevert(ICovenant.OnlyRoleSetter.selector);
        covenant.setFeeSetter(makeAddr("newFeeSetter"));
    }
    ...
    function testSetSettlementFeeSuccess(
        ...
        Market memory market = Market({
            ...
            rcfThreshold: 0,
            entryGate: address(0),
            seizureGate: address(0)
        });
        bytes32 id = toId(market);
        covenant.initMarket(market);

        covenant.setMarketSettlementFee(id, 0, postMaturityFee);
        covenant.setMarketSettlementFee(id, 1, oneDayFee);
        covenant.setMarketSettlementFee(id, 2, sevenDaysFee);
        covenant.setMarketSettlementFee(id, 3, thirtyDaysFee);
        covenant.setMarketSettlementFee(id, 4, ninetyDaysFee);
        covenant.setMarketSettlementFee(id, 5, oneEightyDaysFee);
        covenant.setMarketSettlementFee(id, 6, threeSixtyDaysFee);

        assertEq(covenant.settlementFee(id, 0), postMaturityFee, "post maturity settlement fee");
        assertEq(covenant.settlementFee(id, 1 days), oneDayFee, "one day settlement fee");
        assertEq(covenant.settlementFee(id, 7 days), sevenDaysFee, "seven days settlement fee");
        assertEq(covenant.settlementFee(id, 30 days), thirtyDaysFee, "thirty days settlement fee");
        assertEq(covenant.settlementFee(id, 90 days), ninetyDaysFee, "ninety days settlement fee");
        assertEq(covenant.settlementFee(id, 180 days), oneEightyDaysFee, "one eighty days settlement fee");
        assertEq(covenant.settlementFee(id, 360 days), threeSixtyDaysFee, "three sixty days settlement fee");
        assertEq(covenant.settlementFee(id, 365 days), threeSixtyDaysFee, "three sixty five days settlement fee");
        assertEq(covenant.settlementFee(id, 1000 days), threeSixtyDaysFee, "one thousand days settlement fee");
    }

    function testSetSettlementFeeInvalidIndex(bytes32 id) public {
        vm.expectRevert(ICovenant.InvalidFeeIndex.selector);
        covenant.setMarketSettlementFee(id, 7, 0);
    }

    function testSetDefaultSettlementFeeInvalidIndex(address loanToken) public {
        vm.expectRevert(ICovenant.InvalidFeeIndex.selector);
        covenant.setDefaultSettlementFee(loanToken, 7, 0);
    }
    ...
    function testSetMarketSettlementFeeValueTooHigh(bytes32 id, uint256 feeTooHigh, uint256 index) public {
        ...
        vm.expectRevert(ICovenant.SettlementFeeTooHigh.selector);
        covenant.setMarketSettlementFee(id, index, feeTooHigh);
    }
    ...
    function testSetSettlementFeeNotMultipleOfFeeCbp(bytes32 id, uint256 index, uint256 fee) public {
        ...
        vm.expectRevert(ICovenant.FeeNotMultipleOfFeeCbp.selector);
        covenant.setMarketSettlementFee(id, index, fee);
    }
    ...
    function testSetFeeClaimerOnlyRoleSetter(address rdm) public {
        ...
        vm.prank(rdm);
        vm.expectRevert(ICovenant.OnlyRoleSetter.selector);
        covenant.setFeeClaimer(makeAddr("newRecipient"));
    }
    ...
    function testSettlementFeeRevertsWhenNotCreated() public {
        vm.expectRevert(ICovenant.MarketNotCreated.selector);
        covenant.settlementFee(bytes32(0), 0);
    }
    ...
    function testSetDefaultSettlementFeeSuccess(
        ...
        covenant.setDefaultSettlementFee(loanToken, 0, postMaturityFee);
        covenant.setDefaultSettlementFee(loanToken, 1, oneDayFee);
        covenant.setDefaultSettlementFee(loanToken, 2, sevenDaysFee);
        covenant.setDefaultSettlementFee(loanToken, 3, thirtyDaysFee);
        covenant.setDefaultSettlementFee(loanToken, 4, ninetyDaysFee);
        covenant.setDefaultSettlementFee(loanToken, 5, oneEightyDaysFee);
        covenant.setDefaultSettlementFee(loanToken, 6, threeSixtyDaysFee);
        ...
        assertEq(covenant.settlementFee(id, 0), postMaturityFee, "0 days default fee");
        assertEq(covenant.settlementFee(id, 1 days), oneDayFee, "1 day default fee");
        assertEq(covenant.settlementFee(id, 7 days), sevenDaysFee, "7 days default fee");
        assertEq(covenant.settlementFee(id, 30 days), thirtyDaysFee, "30 days default fee");
        assertEq(covenant.settlementFee(id, 90 days), ninetyDaysFee, "90 days default fee");
        assertEq(covenant.settlementFee(id, 180 days), oneEightyDaysFee, "180 days default fee");
        assertEq(covenant.settlementFee(id, 360 days), threeSixtyDaysFee, "360 days default fee");
        assertEq(covenant.settlementFee(id, 365 days), threeSixtyDaysFee, "365 days default fee");
        assertEq(covenant.settlementFee(id, 1000 days), threeSixtyDaysFee, "1000 days default fee");
    }
    ...
    function testSetDefaultSettlementFeeOnlyFeeSetter(address rdm, address loanToken) public {
        ...
        vm.prank(rdm);
        vm.expectRevert(ICovenant.OnlyFeeSetter.selector);
        covenant.setDefaultSettlementFee(loanToken, 0, 0);
    }
    ...
    function testSetDefaultSettlementFeeValidation(address loanToken, uint256 feeTooHigh, uint256 index) public {
        ...
        feeTooHigh = bound(feeTooHigh, maxSettlementFee(index) + 1, 1e18);
        vm.expectRevert(ICovenant.SettlementFeeTooHigh.selector);
        covenant.setDefaultSettlementFee(loanToken, index, feeTooHigh);
    }
    ...
    function testSettlementFeeLinearInterpolation(
        ...
        covenant.setMarketSettlementFee(id, 0, settlementFee0);
        covenant.setMarketSettlementFee(id, 1, settlementFee1);
        covenant.setMarketSettlementFee(id, 2, settlementFee2);
        covenant.setMarketSettlementFee(id, 3, settlementFee3);
        covenant.setMarketSettlementFee(id, 4, settlementFee4);
        covenant.setMarketSettlementFee(id, 5, settlementFee5);
        covenant.setMarketSettlementFee(id, 6, settlementFee6);

        // Test exact breakpoints
        assertEq(covenant.settlementFee(id, 0), settlementFee0, "0 days");
        assertEq(covenant.settlementFee(id, 1 days), settlementFee1, "1 day");
        assertEq(covenant.settlementFee(id, 7 days), settlementFee2, "7 days");
        assertEq(covenant.settlementFee(id, 30 days), settlementFee3, "30 days");
        assertEq(covenant.settlementFee(id, 90 days), settlementFee4, "90 days");
        assertEq(covenant.settlementFee(id, 180 days), settlementFee5, "180 days");
        assertEq(covenant.settlementFee(id, 360 days), settlementFee6, "360 days");
        ...
        assertEq(covenant.settlementFee(id, 0.5 days), expectedMidpoint, "Midpoint 0-1d");
        ...
        assertEq(covenant.settlementFee(id, 4 days), expectedMid4d, "Midpoint 1-7d");
        ...
        assertEq(covenant.settlementFee(id, 270 days), expectedMid270d, "Midpoint 180-360d");

        // Test beyond 360 days
        assertEq(covenant.settlementFee(id, 365 days), settlementFee6, "365 days");
        assertEq(covenant.settlementFee(id, 1000 days), settlementFee6, "1000 days");
    }
    ...
    function testSetContinuousFeeOnlyFeeSetter(address rdm) public {
        ...
        vm.prank(rdm);
        vm.expectRevert(ICovenant.OnlyFeeSetter.selector);
        covenant.setMarketContinuousFee(id, 100);

        vm.prank(rdm);
        vm.expectRevert(ICovenant.OnlyFeeSetter.selector);
        covenant.setDefaultContinuousFee(address(loanToken), 100);
    }
    ...
    function testSetContinuousFeeTooHigh(uint256 fee) public {
        ...
        vm.expectRevert(ICovenant.ContinuousFeeTooHigh.selector);
        covenant.setMarketContinuousFee(id, fee);

        vm.expectRevert(ICovenant.ContinuousFeeTooHigh.selector);
        covenant.setDefaultContinuousFee(address(loanToken), fee);
    }
    ...
    function testSetContinuousFeeSuccess(uint256 fee, uint256 fee2) public {
        ...
        covenant.setDefaultContinuousFee(address(loanToken), fee);
        assertEq(covenant.defaultContinuousFee(address(loanToken)), fee, "default fee updated");
        ...
        assertEq(covenant.continuousFee(id), fee, "market inherits default fee");
        covenant.setMarketContinuousFee(id, fee2);
        assertEq(covenant.continuousFee(id), fee2, "market fee updated");
    }
}
