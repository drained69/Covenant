...
import {
    ...
    MARKET_TYPEHASH,
    OFFER_TYPEHASH
} from "../src/notaries/libraries/HashLib.sol";
...
bytes constant MARKET_TYPE =
    "Market(address loanToken,CollateralParams[] collateralParams,uint256 maturity,uint256 rcfThreshold,address entryGate,address seizureGate)";
bytes constant OFFER_TYPE =
    "Offer(Market market,bool buy,address maker,uint256 start,uint256 expiry,uint256 tick,bytes32 group,address callback,bytes callbackData,address receiverIfMakerIsSeller,address notary,bool reduceOnly,uint256 maxUnits,uint256 maxAssets)";
