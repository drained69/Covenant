...
uint256 constant LIQUIDATION_LOCK_SLOT = uint256(keccak256("covenant.liquidationLocked"));
bytes32 constant CALLBACK_SUCCESS = keccak256("covenant.callbackSuccess");
